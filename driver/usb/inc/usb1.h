...
#define HS_MAX_PACKET_SIZE           		        (128)//(512)  //This can be modified later, it may be 1~1024.
...
#if 0
/* Best PHY Register settings for Marvell BBIC2 */
#define  INIT_PHY_PLL_CTL           0x8a01a944  /*0x8A01A944*///0x8A01AEE3 //0x8A01A944 //0x8A01e768 //0x0001e769  ///////NOTICE: bits from 21 to 27 and 31 have not been set properly. 20060914
#define  INIT_PHY_TX_CTL            0x6107c3//0x002127D3 //////NOTICE: bit17~20, 22~23 and 30~31 have not been set properly. 20060914
#define  INIT_PHY_RX_CTL            0xe31c82a3//0xe30c8261//0x735D024F //////NOTICE: bit 26, 27 and 31 have not been set properly. 20060915
#define  INIT_PHY_IVREF_CTL         0x31a //0x33a//0x335  //////NOTICE: bit 29~31 have not been set properly. 20060915  
#define  INIT_PHY_REG_TEST0         0x00c01800 /*0x00c09800*/  //////NOTICE: bit 26~31 have not been set properly. 20060915
#define  INIT_PHY_REG_TEST1         /*0xc0000000*/0xc0000000   //0x7e000000//0xC0000000
#define  INIT_PHY_REG_TEST2         0x0
//#else


//@Hongji
//Copied from Hm2-diag software packet
...
#ifdef	C0_8618
#define  INIT_PHY_PLL_CTL           0x0A01A768		//0x182        //1 1010 0011
#define  INIT_PHY_TX_CTL            0x6107c3//0x137C3			//0x117C1 		//0x107C3      //1 0000 1111 1100 0011
#define  INIT_PHY_RX_CTL            0x6d1c82a3 //0x6D1C82A1		//0x7D5D0185   //111 1101 0101 1101 0000 0010 1000 0101
#define  INIT_PHY_IVREF_CTL         0x43a			//0x635        //110 0011 0101
#else	/* 8618_BX */
#define  INIT_PHY_PLL_CTL           0x182       
#define  INIT_PHY_TX_CTL            0x117C1 		//0x107C3      //1 0000 1111 1100 0011
#define  INIT_PHY_RX_CTL            0x7D5D0185   //111 1101 0101 1101 0000 0010 1000 0101
#define  INIT_PHY_IVREF_CTL         0x635        //110 0011 0101
#endif

#define  INIT_PHY_REG_TEST0         0xC09A21     //1100 0000 1001 1010 0000 0000 
#define  INIT_PHY_REG_TEST1         0x00000000   //0000 0000 0000 0000 0000 0000 0000 0000 
#define  INIT_PHY_REG_TEST2         0x0 
