...
#  define LV_MEM_USE_MALLOC_DEFINE           /*define lv_mem_alloc to malloc*/
#  include <stdlib.h>
#endif     /*LV_MEM_CUSTOM*/
...
#define SDK_MMI_POOL_SIZE (4 * 1024 * 1024)
...
#define LV_INDEV_DEF_DRAG_LIMIT           2
...
#define LV_INDEV_DEF_GESTURE_LIMIT        2
...
/*limit cache max mem size, 0 to close this feature */
#define LV_IMG_CACHE_MEM_SIZE_LIMIT  0//(1024*1024*2)
...
//#  define LV_LOG_LEVEL    LV_LOG_LEVEL_TRACE //only used for debug
...
#define LV_WATCH_MOUSEWHEEL 0

/* Image decoder */
#define USE_LV_DRAW_IMG_PNG_DECODER 1
#define USE_LV_DRAW_IMG_JPEG_DECODER 1
#define USE_LV_DRAW_IMG_JPEG_DECODER_HW_MODE 0
#define USE_LV_DRAW_IMG_JPEG_DECODER_INC_JLIB 0

/* GIF player */
#define USE_LV_DRAW_GIF_PLAYER    1

#define USE_LV_FLASH_FS         1
#define USE_LV_ROM_FS           1
#define USE_LV_SD_FS            1
#define USE_LV_BARCODE          1
#define USE_LV_QRCODE           1

#define USE_LV_WATCH_DEMO 1

/* xtimer */
#define TIMER_HZ_32K (32768ul)
#define TIMER_HZ_1M (1000000ul)

#define XTIMER_HZ TIMER_HZ_32K

#if (XTIMER_HZ == TIMER_HZ_32K)
...
/* Bluetooth */
#define USE_LV_BLUETOOTH 1
#define USE_LV_BLE_DEMO 0

/* SD auto mount */
#define USE_LV_WATCH_SD_AUTO_MOUNT 1

/* DM */
#define USE_LV_DM 1

/* WLAN */
#define USE_LV_WLAN 0
