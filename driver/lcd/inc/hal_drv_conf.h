...
#ifndef HAL_DRV_CONF_H
#define HAL_DRV_CONF_H
...
/* crane multimedia clock control */
#define USE_CRANE_MEDIA_CLK 1

/* crane lcd controller */
#ifndef USE_CRANE_LCD
#  define USE_CRANE_LCD                             1
#endif

#ifndef USE_CRANE_LCD_SPI
#  define USE_CRANE_LCD_SPI                         0
#endif

#ifdef USE_CRANE_LCD_MIPI
#  define USE_CRANE_LCD_MIPI_CMD                     1
#  define USE_CRANE_LCD_MIPI_VIDEO                   0
#endif

#ifndef USE_CRANE_LCD_MCU
#  define USE_CRANE_LCD_MCU                         0
#endif

/* lcd panel */
#ifndef USE_LCD_PANEL_ST7789V_SPI_WATCH
#  define USE_LCD_PANEL_ST7789V_SPI_WATCH           0
#endif

#ifndef USE_LCD_PANEL_ST7789V_SPI_PHONE
#  define USE_LCD_PANEL_ST7789V_SPI_PHONE           0
#endif

#ifndef USE_LCD_PANEL_ST7567_SPI_4WIRE_1LANE_1IF
#  define USE_LCD_PANEL_ST7567_SPI_4WIRE_1LANE_1IF           0
#endif

#ifndef USE_LCD_PANEL_ST7789V_MCU
#  define USE_LCD_PANEL_ST7789V_MCU           0
#endif

#ifndef USE_LCD_PANEL_RM69330_MIPI
#  define USE_LCD_PANEL_RM69330_MIPI          0
#endif

#ifndef USE_LCD_PANEL_ICNA3310_MIPI
#  define USE_LCD_PANEL_ICNA3310_MIPI           0
#endif

#define USE_LCD_PANEL_ILI9806E_MIPI      0

#ifndef USE_LCD_RB_SWAP_DISABLE
#define USE_LCD_RB_SWAP_DISABLE              0
#endif
/*********************
 *  INPUT DEVICES
 *********************/
...
#ifndef USE_FT6X36
#  define USE_FT6X36          1
#  define FT6X36_USE_OSA_HISR 1          /* use osa hisr to read tp data */
#endif

#ifndef USE_ZINITIX_TOUCH
#  define USE_ZINITIX_TOUCH          0
#  define ZINITIX_USE_OSA_HISR       0
#endif

/* crane keypad controller */
#ifndef USE_CRANE_KEYPADC
#  define USE_CRANE_KEYPADC    0
#endif

/* crane evb keypad */
#ifndef USE_CRANE_EVB_KEYPAD
#  define USE_CRANE_EVB_KEYPAD    0
#endif

/* crane watch keypad */
#ifndef USE_CRANE_WATCH_KEYPAD
#  define USE_CRANE_WATCH_KEYPAD    1
#  define KEY_LONG_PRESS_DURATION   3000 /* ms */
#  define KEY_POWER_ON_DURATION     800 /* ms */
#  define USE_ONKEY_HISR            1
#  define ONKEY_RESUME_RESET        0
#endif

/* crane jpeg hw decoder & encoder */
#ifndef USE_CRANE_JPU
#  define USE_CRANE_JPU    1
#endif

/* crane camera */
#ifndef USE_CRANE_CAMERA
#  define USE_CRANE_CAMERA    1
#  define USE_CRANE_CAMERA_MULTI 0
#  if USE_CRANE_CAMERA
#    define USE_CRANE_CAMERA_GC030A    1
#    define USE_CRANE_CAMERA_GC032A    0
#    define USE_CRANE_CAMERA_GC0312    0
#    define USE_CRANE_CAMERA_GC2145    0
#  endif  /*USE_CRANE_CAMERA*/
#endif

/* fake battery */
#ifndef FAKE_BATTERY
#  define FAKE_BATTERY    0
#endif

/* LCD te */
#ifndef LCD_TE_ENABLE
#  define LCD_TE_ENABLE   1
#  define LCD_TE_POL      0    /*0: positive; 1:negative */
#endif
...
/* crane local mfp driver */
#ifndef USE_LOCAL_MFP
#  define USE_LOCAL_MFP  0
#endif

#ifndef LCD_GENERIC_SPI
#  define LCD_GENERIC_SPI  0
#endif
