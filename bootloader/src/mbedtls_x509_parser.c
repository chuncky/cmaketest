...
static void ext_dump( ){
	uart_printf("DUMP: tbs\r\n");
	display_binary(tbs.p,tbs.len);
	uart_printf("DUMP: v3_ext\r\n");
	display_binary(v3_ext.p,v3_ext.len);
	uart_printf("DUMP: pk\r\n");
	display_binary(pk.p,pk.len);
	uart_printf("DUMP: sig_alg\r\n");
	display_binary(sig_alg.p,sig_alg.len);
	uart_printf("DUMP: signature\r\n");
	display_binary(signature.p,signature.len);
}
