...
//xiaoke CP_IMAGE
#define UUID_NON_TRUSTED_OS_CP \
	{{0x77,  0xc4, 0xf4, 0x76}, {0x1b, 0x94}, {0x41, 0x7c}, 0xb3, 0x43, {0xb0, 0xea, 0x44, 0x3a, 0xac, 0xd7} }
#define UUID_NON_TRUSTED_OS_DSP \
	{{0x8a,  0xbd, 0x24, 0xeb}, {0xe0, 0x69}, {0x4a, 0xcd}, 0x88, 0x15, {0x30, 0xa9, 0x50, 0xb9, 0x3a, 0x2b} }
#define UUID_NON_TRUSTED_OS_APP \
	{{0xae,  0x72, 0xa4, 0x7c}, {0x74, 0x03}, {0x11, 0xea}, 0xb1, 0x36, {0x9f, 0x37, 0xb4, 0x32, 0x2d, 0x68} }
...
//xiaoke CP_CONTENT_CERT
#define UUID_NON_TRUSTED_CP_CONTENT_CERT \
	{{0x26,  0x31, 0x02, 0xfb}, {0xf9, 0x8e}, {0x42, 0xf8}, 0x98, 0xdf, {0xb0, 0xe1, 0xd3, 0x51, 0x8e, 0x54} }
#define UUID_NON_TRUSTED_DSP_CONTENT_CERT \
	{{0x2b,  0xca, 0xe7, 0xa1}, {0x39, 0x0f}, {0x43, 0xd2}, 0x82, 0x58, {0x45, 0xd5, 0x63, 0xe0, 0x0d, 0x57} }
#define UUID_NON_TRUSTED_APP_CONTENT_CERT \
	{{0xf5,  0x12, 0xb7, 0x74}, {0x74, 0x02}, {0x11, 0xea}, 0x87, 0xf2, {0x87, 0x08, 0xed, 0xbf, 0xec, 0xfb} }
#define UUID_NON_TRUSTED_USER1_CONTENT_CERT \
	{{0x7b,  0x3c, 0x62, 0x20}, {0x74, 0x0b}, {0x11, 0xea}, 0x96, 0x75, {0xe3, 0x1a, 0x25, 0x39, 0x72, 0xc0} }
#define UUID_NON_TRUSTED_USER2_CONTENT_CERT \
	{{0xc0,  0x0f, 0x21, 0x08}, {0x74, 0x0b}, {0x11, 0xea}, 0x9d, 0x9b, {0xeb, 0x7c, 0xa5, 0xd3, 0xcc, 0x6d} }
#define UUID_NON_TRUSTED_USER3_CONTENT_CERT \
	{{0xe5,  0xb8, 0x7e, 0x68}, {0x74, 0x0b}, {0x11, 0xea}, 0x88, 0xd3, {0x9f, 0x0b, 0xe4, 0xe5, 0x26, 0xaa} }
/* Dynamic configs */
