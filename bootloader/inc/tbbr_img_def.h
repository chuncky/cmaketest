...
/* Binary with ASR header */
#define ASR_OS_CP_IMAGE_ID			U(30)
#define ASR_OS_CP_KEY_CERT_ID		U(31)
#define ASR_OS_DSP_IMAGE_ID			U(32)
#define ASR_OS_DSP_KEY_CERT_ID		U(33)

#define ASR_OS_APP_IMAGE_ID			U(34)
#define ASR_OS_APP_KEY_CERT_ID		U(35)
#define ASR_OS_USER1_IMAGE_ID			U(36)
#define ASR_OS_USER1_KEY_CERT_ID		U(37)
#define ASR_OS_USER2_IMAGE_ID			U(38)
#define ASR_OS_USER2_KEY_CERT_ID		U(39)
#define ASR_OS_USER3_IMAGE_ID			U(40)
#define ASR_OS_USER3_KEY_CERT_ID		U(41)

/* Define size of the array */
#define MAX_NUMBER_IDS			U(42)
