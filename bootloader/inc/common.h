...
/*+++++++++++++BOOT33 Log_Priority Start++++++++++++++++++++++++*/
#define BOOT33_LOGSEVERITY_D 1
#define BOOT33_LOGSEVERITY_I 2
#define BOOT33_LOGSEVERITY_W 3
#define BOOT33_LOGSEVERITY_E 4

#ifndef BOOT33_LOGSEVERITY
#define BOOT33_LOGSEVERITY BOOT33_LOGSEVERITY_I	/* use macro "BOOT33_LOGSEVERITY" to control uart log priority */
#endif

#ifndef BOOT33_LOGNDEBUG
	#ifdef BOOT33_NDEBUG						/* use macro "BOOT33_NDEBUG" to control debug log in specific *.c file */
	#define BOOT33_LOGNDEBUG 1		
	#else
	#define BOOT33_LOGNDEBUG 0
	#endif
#endif

#define BOOT33_UART_PRINTF uart_printf

#if BOOT33_LOGNDEBUG
#define CP_LOGD(x,...)
#else
#define CP_LOGD(x,...) do{if (BOOT33_LOGSEVERITY <= BOOT33_LOGSEVERITY_D) BOOT33_UART_PRINTF(x,##__VA_ARGS__);}while(0)
#endif

#define CP_LOGI(x,...) do{if (BOOT33_LOGSEVERITY <= BOOT33_LOGSEVERITY_I) BOOT33_UART_PRINTF(x,##__VA_ARGS__);}while(0)
#define CP_LOGW(x,...) do{if (BOOT33_LOGSEVERITY <= BOOT33_LOGSEVERITY_W) BOOT33_UART_PRINTF(x,##__VA_ARGS__);}while(0)
#define CP_LOGE(x,...) do{if (BOOT33_LOGSEVERITY <= BOOT33_LOGSEVERITY_E) BOOT33_UART_PRINTF(x,##__VA_ARGS__);}while(0)

/*+++++++++++++BOOT33 Log_Priority End++++++++++++++++++++++++*/
...
#define QSPI0_DB16_FLASH_A1_TOP   0x81000000
#define QSPI0_DB16_FLASH_A2_BASE  0x81000000
