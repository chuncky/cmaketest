...
static  int list_add_by_index(struct list_head *new, struct list_head *head, int index)
{
    list_t *pos = head;
    int i = -1;
...
#define GET_ENTRY_BY_INDEX(func, entrytype, member) \
        static  entrytype* func (list_t *head, int index) \
        { \
            list_t *me; \
            int i = 0; \
            \
...
#define GET_ENTRY_INDEX(func, entrytype, member) \
        static  int func (list_t *head, entrytype* entry) \
        { \
            list_t *me; \
            int i = 0; \
            \
