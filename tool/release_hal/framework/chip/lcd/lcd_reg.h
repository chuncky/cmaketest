...
#define LCD_GPIO_0 0x1
#define LCD_GPIO_1 0x2
#define LCD_GPIO_2 0x4
#define LCD_GPIO_3 0x8
#define LCD_GPIO_4 0x10
#define LCD_GPIO_5 0x20
#define LCD_GPIO_6 0x40
...
#define PN_SEPXLCNT 0x13C

#define SPI_RXDATA 0x140
#define ISA_RXDATA 0x144

#define PN_GAMMA_RDDAT 0x15C
...
/*SPI use bit_20, mcu use bit_21*/
#ifdef LCD_MCU
#define IRQ_FRAME_DONE BIT_21
#else
#define IRQ_FRAME_DONE BIT_20
#endif
