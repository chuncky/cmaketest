...
/******************************************************************************/
//Dont support size in current 
#define ERR_COMMON                            			  0x19
/******************************************************************************/

/******************************************************************************/
//Dont support size in current 
#define ERR_CONF_CALL_MEMBERS_LIMITED					  0x20
/******************************************************************************/
...
/******************************************************************************/
//This function is not suppoted now.
#define ERR_DRV_NOT_SUPPORT                               0x4080003
/******************************************************************************/

/******************************************************************************/
//Not more data to request, maybe your nNumberOfBytesToRead is too large such as
// exceed the flash total size..
#define ERR_DRV_OPERATION_NOT_GRANTED                     0x4080004
/******************************************************************************/

/******************************************************************************/
//Don't find the valid  device such as LCD. May be you don't install the device 
//drive or the device device is bad, for example the LCD device should support '
//flat frame' display buffer
#define ERR_DRV_DEVICE_NOT_FOUND                          0x4080005
/******************************************************************************/

/******************************************************************************/
//The access to flash file(bin/emu.fla) is invalid on emulator, maybe fail to op
//en file (not existing or flash file is crash or flash file is occupied by the 
//other process),   or don't access flash on the target, maybe flash is collapse
//d.
#define ERR_DRV_INVALID_ACCESS                            0x4080006
/******************************************************************************/
...
/******************************************************************************/
//The UOS message queue is full, you don't send message to the specified queue.
#define ERR_UOS_QUEUE_FULL                               0xc180000
/******************************************************************************/


/******************************************************************************/
//The input parameter is invalid
#define ERR_CMID_INVALID_PARAMETER                         0x10000001
/******************************************************************************/

/******************************************************************************/
//The message queue is full, you don't send message to the specified queue.
#define ERR_CMID_QUEUE_FULL                                0x10000002
/******************************************************************************/

/******************************************************************************/
//Don't support this function now
#define ERR_CMID_NOT_SUPPORT                               0x10000003
/******************************************************************************/

/******************************************************************************/
//Don't find any operator identifier in the system.
#define ERR_CMID_NOT_EXIST_OPERATOR_ID                     0x10000004
/******************************************************************************/

/******************************************************************************/
//No any available free UTI in the system.
#define ERR_CMID_NOT_EXIST_FREE_UTI                        0x10000005
/******************************************************************************/

/******************************************************************************/
//Don't find any operator name in the system.
#define ERR_CMID_NOT_EXIST_OPERATOR_NAME                   0x10000006
/******************************************************************************/
...
/******************************************************************************/
//CMID_NOT_OPERATOR_ID
#define ERR_CMID_NOT_OPERATOR_ID                           0x10000009
/******************************************************************************/
...
/******************************************************************************/
//AOM_FAILURE
#define ERR_CMID_NOT_EXIST_AO                             0x1000000d
/******************************************************************************/
...
/******************************************************************************/
//
#define ERR_CMID_UTI_IS_BUSY                               0x1000001a
/******************************************************************************/

/******************************************************************************/
//
#define ERR_CMID_UTI_INVALID                               0x1000001b
/******************************************************************************/
...
#define ERR_CMID_SIM_NOT_INITIATE 0x1000001e
/******************************************************************************/

/******************************************************************************/
//Error Code defined for CC module
#define ERR_CMID_OTHER_SIM_IN_CALL 0x1000001f
/******************************************************************************/

/******************************************************************************/
#define ERR_CMID_NO_CALL_INPROGRESS 0x10000020
/******************************************************************************/
//]]hameina [+] for 221 project
