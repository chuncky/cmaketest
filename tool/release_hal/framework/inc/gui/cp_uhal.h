#if 0	//fixme-asr-remove
/*------------------------------------------------------------
(C) Copyright [2018-2020] ASR Ltd.
All Rights Reserved
------------------------------------------------------------*/

#ifndef __CP_CMID_H__
#define __CP_CMID_H__
...
#define CP_CSW_CMID				( CP_CSW + 1700)
...
#define CP_CMID_RegisterAo                ( CP_CSW_AOM + 1 )   
#define CP_DeleteReadyAO                 ( CP_CSW_AOM + 2 )   
#define CP_CMID_UnRegisterAO            ( CP_CSW_AOM + 3 )   
#define CP_CMID_SetAoProcCode         ( CP_CSW_AOM + 4 )   
#define CP_TriggerStateMachine          ( CP_CSW_AOM + 5 )   
#define CP_CMID_AoScheduler             ( CP_CSW_AOM + 6 )   
#define CP_CMID_PostNotifyEvent        (CP_CSW_AOM + 7 )

//
//Gprs
//
#define CP_Gprs_MSG_Redirect                                (CP_CSW_GPRS + 0)
#define CP_CMID_GprsAoProc                                    (CP_CSW_GPRS + 1)
#define CP_GprsMTAoProc                                        (CP_CSW_GPRS + 2)
#define CP_CMID_GprsGetPdpAddr                             (CP_CSW_GPRS + 3)
#define CP_CMID_GetGprsActState                             (CP_CSW_GPRS + 4)
#define CP_CMID_GprsAct                                          (CP_CSW_GPRS + 5)
#define CP_CMID_GprsCtxModify                                (CP_CSW_GPRS + 6)
#define CP_CMID_GprsSendData                                (CP_CSW_GPRS + 7)
#define CP_CMID_GprsSetPdpCxt                               (CP_CSW_GPRS + 8)
#define CP_CMID_GprsGetPdpCxt                               (CP_CSW_GPRS + 9)
#define CP_CMID_GprsSetReqQos                               (CP_CSW_GPRS + 10)
#define CP_CMID_GprsGetReqQos                               (CP_CSW_GPRS + 11)
#define CP_CMID_GprsSetMinQos                               (CP_CSW_GPRS + 12)
#define CP_CMID_GprsGetMInQos                               (CP_CSW_GPRS + 13)
#define CP_CMID_GprsQos2Api                                  (CP_CSW_GPRS + 14)
#define CP_CMID_GprsApi2Qos                                  (CP_CSW_GPRS + 15)
#define CP_CMID_GprsGetFreeCid                              (CP_CSW_GPRS + 16)
#define CP_CMID_GprsManualAcc                              (CP_CSW_GPRS + 17)
#define CP_CMID_GprsManualRej                               (CP_CSW_GPRS + 18)
...
#define CP_CMID_NwAoProc                                     ( CP_CSW_NW + 1 )   
#define CP_CMID_NwGetAvailableOperators               ( CP_CSW_NW + 2 )   
#define CP_CMID_NwGetCurrentOperator                   ( CP_CSW_NW + 3 )   
#define CP_CMID_NwGetImei                                    ( CP_CSW_NW + 4 )   
#define CP_CMID_NwGetSignalQuality                        ( CP_CSW_NW + 5 )   
#define CP_CMID_NwSetRegistration                          ( CP_CSW_NW + 6 )   
#define CP_CMID_NwStartStack                                 ( CP_CSW_NW + 7 )   
#define CP_CMID_NwStopStack                                 ( CP_CSW_NW + 8 )   
#define CP_CMID_NwQualReportConf                         ( CP_CSW_NW + 9 )   
#define CP_CMID_NwListConf                                    ( CP_CSW_NW + 10 )   
#define CP_CMID_NwPsStatusConf                             ( CP_CSW_NW + 11 )   
#define CP_CMID_NwCsStatusConf                            ( CP_CSW_NW + 12 )   
#define CP_CMID_GprsAtt                                         ( CP_CSW_NW + 13 )   
#define CP_CMID_GetGprsAttState                             ( CP_CSW_NW + 14 )   
#define CP_CMID_GprsGetstatus                                ( CP_CSW_NW + 15 )   
#define CP_CMID_NwAbortListOperators                     ( CP_CSW_NW + 16 )   
#define CP_CMID_GprsDeactiveAll                             ( CP_CSW_NW + 17 )   
...
#define CP_CMID_TcpipInetAddr                                           ( CP_CSW_TCPIP + 57 )
...
#define CP_free_mem                                                ( CP_CSW_TCPIP + 82 )
...
#define CP_free_memp                                               ( CP_CSW_TCPIP + 89 )
...
#define CP_free_ui_pbuf                                               ( CP_CSW_TCPIP + 107)
...
#define CP_CMID_TcpipAvailableBuffer                                    ( CP_CSW_TCPIP + 133)
#define CP_CMID_TcpipGetLastError                                       ( CP_CSW_TCPIP + 134)
#define CP_CMID_TcpipSocket                                             ( CP_CSW_TCPIP + 135)
#define CP_CMID_TcpipSocketAccept                                       ( CP_CSW_TCPIP + 136)
#define CP_CMID_TcpipSocketBind                                         ( CP_CSW_TCPIP + 137)
#define CP_CMID_TcpipSocketClose                                        ( CP_CSW_TCPIP + 138)
#define CP_CMID_TcpipSocketConnect                                      ( CP_CSW_TCPIP + 139)
#define CP_CMID_TcpipSocketGetpeername                                  ( CP_CSW_TCPIP + 140)
#define CP_CMID_TcpipSocketGetsockname                                  ( CP_CSW_TCPIP + 141)
#define CP_CMID_TcpipSocketGetsockopt                                   ( CP_CSW_TCPIP + 142)
#define CP_CMID_TcpipSocketIoctl                                        ( CP_CSW_TCPIP + 143)
#define CP_CMID_TcpipSocketListen                                       ( CP_CSW_TCPIP + 144)
#define CP_CMID_TcpipSocketRead                                         ( CP_CSW_TCPIP + 145)
#define CP_CMID_TcpipSocketRecv                                         ( CP_CSW_TCPIP + 146)
#define CP_CMID_TcpipSocketRecvfrom                                     ( CP_CSW_TCPIP + 147)
#define CP_CMID_TcpipSocketSelect                                       ( CP_CSW_TCPIP + 148)
#define CP_CMID_TcpipSocketSelscan                                      ( CP_CSW_TCPIP + 149)
#define CP_CMID_TcpipSocketSend                                         ( CP_CSW_TCPIP + 150)
#define CP_CMID_TcpipSocketSendto                                       ( CP_CSW_TCPIP + 151)
#define CP_CMID_TcpipSocketSetsockopt                                   ( CP_CSW_TCPIP + 152)
#define CP_CMID_TcpipSocketShutdown                                     ( CP_CSW_TCPIP + 153)
#define CP_CMID_TcpipSocketWrite                                        ( CP_CSW_TCPIP + 154)
...
#define CP_CSW_SIM_GENERAL_BASE		(CP_CSW_CMID + 0)
#define CP_CSW_SIM_PBK_BASE			(CP_CSW_CMID + 60)	  
#define CP_CSW_SIM_SMS_BASE			(CP_CSW_CMID + 80)	
#define CP_CSW_SIM_SAT_BASE			(CP_CSW_CMID + 130)	
#define CP_CSW_CC_BASE				(CP_CSW_CMID + 140)
#define CP_CSW_SS_BASE				(CP_CSW_CMID + 200)
#define CP_CSW_EMOD_BASE			(CP_CSW_CMID + 250)
#define CP_CSW_CFG_BASE				(CP_CSW_CMID + 270)
#define CP_CSW_SMS_BASE				(CP_CSW_CMID + 400)	
#define CP_CSW_SHELL_BASE			(CP_CSW_CMID + 550)

//
//sim_sms
//
#define CP_CMID_SimReadMessage			CP_CSW_SIM_SMS_BASE + 2
#define CP_CMID_SimWriteMessage			CP_CSW_SIM_SMS_BASE + 3
#define CP_CMID_SimListMessage			CP_CSW_SIM_SMS_BASE + 4
#define CP_CMID_SimDeleteMessage			CP_CSW_SIM_SMS_BASE + 5
#define CP_CMID_SimReadBinary			CP_CSW_SIM_SMS_BASE + 6
#define CP_CMID_SimUpdateBinary			CP_CSW_SIM_SMS_BASE + 7
#define CP_CMID_SimSetMR					CP_CSW_SIM_SMS_BASE + 8
#define CP_CMID_SimGetMR					CP_CSW_SIM_SMS_BASE + 9
#define CP_CMID_SimGetSmsStorageInfo		CP_CSW_SIM_SMS_BASE + 11
#define CP_CMID_SimSetSmsParameters		CP_CSW_SIM_SMS_BASE + 12
#define CP_CMID_SimSmsInitProc			CP_CSW_SIM_SMS_BASE + 13
#define CP_CMID_SimSmsInit				CP_CSW_SIM_SMS_BASE + 14
#define CP_CMID_DecomposePDU				CP_CSW_SIM_SMS_BASE + 15
#define CP_CMID_SimReadMessageProc		CP_CSW_SIM_SMS_BASE + 16
#define CP_CMID_SimWriteMessageProc		CP_CSW_SIM_SMS_BASE + 17
#define CP_CMID_SimListMessageProc		CP_CSW_SIM_SMS_BASE + 19
#define CP_CMID_SimReadBinaryProc		CP_CSW_SIM_SMS_BASE + 20
#define CP_CMID_SimUpdateBinaryProc		CP_CSW_SIM_SMS_BASE + 21
#define CP_CMID_SimGetMRProc				CP_CSW_SIM_SMS_BASE + 22
#define CP_CMID_SimSetMRProc				CP_CSW_SIM_SMS_BASE + 23
#define CP_CMID_SimGetSmsStorageInfoProc	CP_CSW_SIM_SMS_BASE + 24
#define CP_CMID_SimGetSmsParametersProc	CP_CSW_SIM_SMS_BASE + 25
#define CP_CMID_SimSetSmsParametersProc	CP_CSW_SIM_SMS_BASE + 26

#define CP_CMID_SimTestProc          	CP_CSW_SIM_SMS_BASE + 27
#define CP_CMID_SimTest              	CP_CSW_SIM_SMS_BASE + 28
...
#define CP_cmid_IMSItoASC               	CP_CSW_SIM_SMS_BASE + 45
#define CP_cmid_PLMNtoBCD               	CP_CSW_SIM_SMS_BASE + 46
#define CP_cmid_BCDtoPLMN               	CP_CSW_SIM_SMS_BASE + 47
#define CP_CMID_SimGetAuthenStatusProc  	            CP_CSW_SIM_SMS_BASE + 48
#define CP_CMID_SimEnterAuthenticationProc           CP_CSW_SIM_SMS_BASE + 49
#define CP_CMID_SimChangePasswordProc               	CP_CSW_SIM_SMS_BASE + 50
#define CP_CMID_SimGetFacilityProc               	CP_CSW_SIM_SMS_BASE + 51


#define CP_CMID_SimGetAuthenticationStatus         	CP_CSW_SIM_SMS_BASE + 52
#define CP_CMID_SimEnterAuthentication              	CP_CSW_SIM_SMS_BASE + 53
#define CP_CMID_SimChangePassword                   	CP_CSW_SIM_SMS_BASE + 54
#define CP_CMID_SimGetFacilityLock               	CP_CSW_SIM_SMS_BASE + 55
#define CP_CMID_SimSetFacilityLock               	CP_CSW_SIM_SMS_BASE + 56

#define CP_CMID_SimGetECC                         	CP_CSW_SIM_SMS_BASE + 57
#define CP_CMID_SimSetECC                          	CP_CSW_SIM_SMS_BASE + 58
#define CP_CMID_SimGetLP                            	CP_CSW_SIM_SMS_BASE + 59
#define CP_SimSpySimCard                           	CP_CSW_SIM_SMS_BASE + 60
#define CP_CMID_SimInitStage3                       	CP_CSW_SIM_SMS_BASE + 61

#define CP_CMID_SimInitStage2                     	CP_CSW_SIM_SMS_BASE + 62
#define CP_CMID_SimInit                            	CP_CSW_SIM_SMS_BASE + 63
#define CP_CMID_SimGetPUCT                          	CP_CSW_SIM_SMS_BASE + 64
#define CP_CMID_SimSetPUCT                          	CP_CSW_SIM_SMS_BASE + 65
#define CP_CMID_SimGetProviderId                    	CP_CSW_SIM_SMS_BASE + 66

#define CP_CMID_SimSetPrefOperatorList              	CP_CSW_SIM_SMS_BASE + 67
#define CP_CMID_SimGetPrefOperatorList              	CP_CSW_SIM_SMS_BASE + 68
#define CP_CMID_SimGetPrefOperatorListMaxNum        	CP_CSW_SIM_SMS_BASE + 69
#define CP_CMID_SimGetACM                           	CP_CSW_SIM_SMS_BASE + 70
#define CP_CMID_SimSetACMMax                        	CP_CSW_SIM_SMS_BASE + 71
#define CP_CMID_SimGetACMMax                        	CP_CSW_SIM_SMS_BASE + 72
#define CP_CMID_SimReSetACM                        	CP_CSW_SIM_SMS_BASE + 73

#define CP_CMID_SimInitStage3Proc                  	CP_CSW_SIM_SMS_BASE + 74
#define CP_CMID_SimInitStage1Proc                  	CP_CSW_SIM_SMS_BASE + 75
#define CP_CMID_SimGetPUCTProc                   	CP_CSW_SIM_SMS_BASE + 76
#define CP_CMID_SimSetPUCTProc                      	CP_CSW_SIM_SMS_BASE + 77
#define CP_CMID_SimMisGetProviderIdProc             	CP_CSW_SIM_SMS_BASE + 78
#define CP_CMID_SimMisSetPrefListProc               	CP_CSW_SIM_SMS_BASE + 79
#define CP_CMID_SimMisGetPrefListProc              	CP_CSW_SIM_SMS_BASE + 80

#define CP_CMID_SimMisGetPrefListMAXNumProc         	CP_CSW_SIM_SMS_BASE + 81
#define CP_CMID_SimMisGetACMProc                    	CP_CSW_SIM_SMS_BASE + 82
#define CP_CMID_SimMisReSetACMProc               	CP_CSW_SIM_SMS_BASE + 83
#define CP_CMID_SimSetACMMaxProc                    	CP_CSW_SIM_SMS_BASE + 84
#define CP_CMID_SimGetACMMaxProc                    	CP_CSW_SIM_SMS_BASE + 85


#define CP_CMID_SimAddPbkEntry                     	CP_CSW_SIM_SMS_BASE + 86
#define CP_CMID_SimDeletePbkEntry                  	CP_CSW_SIM_SMS_BASE + 87
#define CP_CMID_SimGetPbkEntry                   	CP_CSW_SIM_SMS_BASE + 88
#define CP_CMID_SimListCountPbkEntries              	CP_CSW_SIM_SMS_BASE + 89
#define CP_CMID_SimListPbkEntries                 	CP_CSW_SIM_SMS_BASE + 90
#define CP_CMID_SimGetPbkStrorageInfo              	CP_CSW_SIM_SMS_BASE + 92
#define CP_CMID_SimGetPbkStorage                  	CP_CSW_SIM_SMS_BASE + 93

#define CP_CMID_SatActivation                      	CP_CSW_SIM_SMS_BASE + 94
#define CP_CMID_SatResponse                         	CP_CSW_SIM_SMS_BASE + 95
#define CP_CMID_SatGetInformation                   	CP_CSW_SIM_SMS_BASE + 96
#define CP_CMID_SatResponseProc                   	CP_CSW_SIM_SMS_BASE + 97
#define CP_CMID_SatActivationProc                   	CP_CSW_SIM_SMS_BASE + 98
#define CP_CMID_SimGetSmsParameters              	CP_CSW_SIM_SMS_BASE + 99
#define CP_CMID_SimDeleMessageProc                  	CP_CSW_SIM_SMS_BASE + 100


//
//shell
//
#define CP_BAL_CmidSetupCbs				CP_CSW_SHELL_BASE + 1
#define CP_CMID_ShellControl				CP_CSW_SHELL_BASE + 2
#define CP_CMID_ShellProc				CP_CSW_SHELL_BASE + 3
...
#define CP_CMID_SmsCopyMessages                  CP_CSW_SMS_BASE + 38
#define CP_CMID_SmsDeleteMessage                 CP_CSW_SMS_BASE + 39
#define CP_CMID_SmsDeleteMessageSync             CP_CSW_SMS_BASE + 40
#define CP_CMID_SmsGetMessageNode                CP_CSW_SMS_BASE + 41
#define CP_CMID_SmsListMessages                  CP_CSW_SMS_BASE + 42
#define CP_CMID_SmsListMessagesHeader            CP_CSW_SMS_BASE + 43
#define CP_CMID_SmsListMessagesHeaderSync        CP_CSW_SMS_BASE + 44
#define CP_CMID_SmsListMessagesSync              CP_CSW_SMS_BASE + 45
#define CP_CMID_SmsNewSmsAck                     CP_CSW_SMS_BASE + 46
#define CP_CMID_SmsQueryOverflowInd              CP_CSW_SMS_BASE + 47
#define CP_CMID_SmsReadMessage                   CP_CSW_SMS_BASE + 48
#define CP_CMID_SmsReadMessageSync               CP_CSW_SMS_BASE + 49
#define CP_CMID_SmsSendMessage                   CP_CSW_SMS_BASE + 50
#define CP_CMID_SmsSetUnRead2Read                CP_CSW_SMS_BASE + 51
#define CP_CMID_SmsSetUnRead2ReadSync            CP_CSW_SMS_BASE + 52
#define CP_CMID_SmsSetUnSent2Sent                CP_CSW_SMS_BASE + 53
#define CP_CMID_SmsSetUnSent2SentSync            CP_CSW_SMS_BASE + 54
#define CP_CMID_SmsWriteMessage                  CP_CSW_SMS_BASE + 55
#define CP_CMID_SmsWriteMessageSync              CP_CSW_SMS_BASE + 56
#define CP_CMID_SIMSmsInit                       CP_CSW_SMS_BASE + 57
#define CP_CMID_SmsCbInit                        CP_CSW_SMS_BASE + 59
#define CP_CMID_SmsMoInit                        CP_CSW_SMS_BASE + 60
#define CP_CMID_SmsMtInit                        CP_CSW_SMS_BASE + 61
...
#define CP_CMID_MeDeleteMessage_Ex               CP_CSW_SMS_BASE + 76
#define CP_CMID_MeGetStorageInfo_Ex              CP_CSW_SMS_BASE + 77
#define CP_CMID_MeListMessage_Ex                 CP_CSW_SMS_BASE + 78
#define CP_CMID_MeReadMessage_Ex                 CP_CSW_SMS_BASE + 79
#define CP_CMID_MeWriteMessage_Ex                CP_CSW_SMS_BASE + 80
#define CP_CMID_SmsMoInit_Ex                     CP_CSW_SMS_BASE + 81
#define CP_SMS_SFSim2User_Ex                    CP_CSW_SMS_BASE + 82
#define CP_SMS_SFUser2Sim_Ex                    CP_CSW_SMS_BASE + 83
#define CP_CMID_MeDeleteMessage                  CP_CSW_SMS_BASE + 84
#define CP_CMID_MeGetStorageInfo                 CP_CSW_SMS_BASE + 85
#define CP_CMID_MeListMessage                    CP_CSW_SMS_BASE + 86
#define CP_CMID_MeReadMessage                    CP_CSW_SMS_BASE + 87
#define CP_CMID_MeWriteMessage                   CP_CSW_SMS_BASE + 88
...
#define CP_CMID_SmsSetRead2UnRead                CP_CSW_SMS_BASE + 108
#define CP_CMID_SmsComposePdu                    CP_CSW_SMS_BASE + 109

//
//sim_pbk
//
#define CP_CMID_SimPBKAddProc				CP_CSW_SIM_PBK_BASE+1
#define CP_CMID_SimPBKDelProc				CP_CSW_SIM_PBK_BASE+2
#define CP_CMID_SimPBKEntryProc				CP_CSW_SIM_PBK_BASE+3
#define CP_CMID_SimPBKListEntryProc			CP_CSW_SIM_PBK_BASE+4
#define CP_CMID_SimPBKListCountEntryProc		CP_CSW_SIM_PBK_BASE+5
#define CP_CMID_SimPBKStorageInfoProc		CP_CSW_SIM_PBK_BASE+6
#define CP_CMID_SimPBKStorageProc			CP_CSW_SIM_PBK_BASE+7
#define CP_cmid_SimParsePBKRecData			CP_CSW_SIM_PBK_BASE+8
//
//sim_emod
//
#define CP_CMID_EMOD_GetBatteryInfo			CP_CSW_EMOD_BASE+1
#define CP_CMID_EMOD_AudioTestStart			CP_CSW_EMOD_BASE+2
#define CP_CMID_EMOD_AudioTestEnd			CP_CSW_EMOD_BASE+3
#define CP_CMID_EMOD_ClearUserInfo			CP_CSW_EMOD_BASE+4
#define CP_CMID_EMOD_GetIMEI 				CP_CSW_EMOD_BASE+5
...
#define CP_CMID_CcInit			            CP_CSW_CC_BASE+4
#define CP_CMID_CcAoProc			        CP_CSW_CC_BASE+5
#define CP_CMID_CcInitiateSpeechCall	    CP_CSW_CC_BASE+6
#define CP_CMID_CcInitiateSpeechCallEx	    CP_CSW_CC_BASE+7 
#define CP_CMID_CcReleaseCall		        CP_CSW_CC_BASE+8
#define CP_CMID_CcAcceptSpeechCall		    (0+9)
#define CP_CmMTAoProc			            CP_CSW_CC_BASE+10
#define CP_CMID_CcGetCurrentCall		    CP_CSW_CC_BASE+11
#define CP_GetCallStatus			        CP_CSW_CC_BASE+12
#define CP_CMID_CcGetCallStatus		        CP_CSW_CC_BASE+13
#define CP_CMID_CcCallHoldMultiparty	    CP_CSW_CC_BASE+14
#define CP_CMID_CcEmcDial			        CP_CSW_CC_BASE+15
#define CP_CMID_CcEmcDialEx			        CP_CSW_CC_BASE+16
#define CP_CMID_CcPlayTone			        CP_CSW_CC_BASE+17
#define CP_CMID_CcRejectCall		        CP_CSW_CC_BASE+18
...
//ss
//
#define CP_CMID_SsInit				        CP_CSW_SS_BASE+1
#define CP_CMID_SsStaticAoProc			    CP_CSW_SS_BASE+2
#define CP_CMID_SsAoProc				    CP_CSW_SS_BASE+3
...
#define CP_CMID_SsQueryCallWaiting 		CP_CSW_SS_BASE+15
#define CP_CMID_SsSetCallWaiting 		CP_CSW_SS_BASE+16
#define CP_CMID_SsQueryCallForwarding 	CP_CSW_SS_BASE+17
#define CP_CMID_SsSetCallForwarding 		CP_CSW_SS_BASE+18
#define CP_CMID_SsSetFacilityLock 		CP_CSW_SS_BASE+19
#define CP_CMID_SsQueryFacilityLock 		CP_CSW_SS_BASE+20
#define CP_CMID_SsChangePassword 		CP_CSW_SS_BASE+21
#define CP_CMID_SsQueryClip 			    CP_CSW_SS_BASE+22
#define CP_CMID_SsQueryClir 			    CP_CSW_SS_BASE+23
#define CP_CMID_SsQueryColp 			    CP_CSW_SS_BASE+24
#define CP_CMID_SsQueryColr 			    CP_CSW_SS_BASE+25
#define CP_CMID_SsSendUSSD 			    CP_CSW_SS_BASE+26
#define CP_CMID_SsTerminate 			    CP_CSW_SS_BASE+27
...
//GENERAL PART
#define CP_CMID_CfgSetPhoneFunctionality CP_CSW_CFG_BASE+1
#define CP_CMID_CfgGetPhoneFunctionality CP_CSW_CFG_BASE+2
#define CP_CMID_CfgStoreUserProfile      CP_CSW_CFG_BASE+3
#define CP_CMID_CfgRestoreFactoryProfile CP_CSW_CFG_BASE+4
#define CP_CMID_CfgGetUserProfile        CP_CSW_CFG_BASE+5

#define CP_CMID_CfgSetServiceReportingMode CP_CSW_CFG_BASE+6
#define CP_CMID_CfgGetServiceReportingMode CP_CSW_CFG_BASE+7
#define CP_CMID_CfgSetRLPType               CP_CSW_CFG_BASE+8
#define CP_CMID_CfgGetRLPType               CP_CSW_CFG_BASE+9
#define CP_CMID_CfgGetCharacterSet          CP_CSW_CFG_BASE+10

#define CP_CMID_CfgSetCharacterSet        CP_CSW_CFG_BASE+11
#define CP_CMID_CfgSetIndicatorEvent      CP_CSW_CFG_BASE+12
#define CP_CMID_CfgGetIndicatorEvent      CP_CSW_CFG_BASE+13
#define CP_CMID_CfgSetIndicatorEventInfo  CP_CSW_CFG_BASE+14
#define CP_CMID_CfgGetIndicatorEventInfo  CP_CSW_CFG_BASE+15

#define CP_CMID_CfgGetEventReport    CP_CSW_CFG_BASE+16
#define CP_CMID_CfgSetEventReport    CP_CSW_CFG_BASE+17
#define CP_CMID_CfgSetResultCodeFormatMode CP_CSW_CFG_BASE+18
#define CP_CMID_CfgSetResultCodePresentMode  CP_CSW_CFG_BASE+19
#define CP_CMID_CfgGetResultCodePresentMode  CP_CSW_CFG_BASE+20

#define CP_CMID_CfgGetResultCodeFormatMode CP_CSW_CFG_BASE+21
#define CP_CMID_CfgSetEchoMode               CP_CSW_CFG_BASE+22
#define CP_CMID_CfgGetEchoMode               CP_CSW_CFG_BASE+23
#define CP_CMID_CfgGetProductIdentification  CP_CSW_CFG_BASE+24
#define CP_CMID_CfgGetExtendedErrorV0        CP_CSW_CFG_BASE+25

#define CP_CMID_CfgSetExtendedErrorV0   CP_CSW_CFG_BASE+26
#define CP_CMID_CfgGetExtendedErrorV1   CP_CSW_CFG_BASE+27
#define CP_CMID_CfgGetErrorReport       CP_CSW_CFG_BASE+28
#define CP_CMID_CfgSetErrorReport       CP_CSW_CFG_BASE+29
#define CP_CMID_GetAtCapability         (CP_CSW_CFG_BASE+30)

//sms
#define CP_CMID_CfgSetSmsStorage      CP_CSW_CFG_BASE+31
#define CP_CMID_CfgGetSmsStorage      CP_CSW_CFG_BASE+32
#define CP_CMID_CfgSelectSmsService   CP_CSW_CFG_BASE+33
#define CP_CMID_CfgQuerySmsService    CP_CSW_CFG_BASE+34
#define CP_CMID_CfgSetSmsOverflowInd   CP_CSW_CFG_BASE+35

#define CP_CMID_CfgGetSmsOverflowInd   CP_CSW_CFG_BASE+36
#define CP_CMID_CfgSetSmsFormat   CP_CSW_CFG_BASE+37
#define CP_CMID_CfgGetSmsFormat   CP_CSW_CFG_BASE+38
#define CP_CMID_CfgSetSmsShowTextModeParam CP_CSW_CFG_BASE+39
#define CP_CMID_CfgGetSmsShowTextModeParam CP_CSW_CFG_BASE+40

#define CP_CMID_CfgSetSmsCB   CP_CSW_CFG_BASE+41
#define CP_CMID_CfgGetSmsCB CP_CSW_CFG_BASE+42
#define CP_CMID_CfgSetNewSmsAck    CP_CSW_CFG_BASE+43
#define CP_CMID_CfgGetNewSmsAck    CP_CSW_CFG_BASE+44
#define CP_CMID_CfgSetSmsCenter   CP_CSW_CFG_BASE+45

#define CP_CMID_CfgGetSmsCenter   CP_CSW_CFG_BASE+46
#define CP_CMID_CfgSetSmsFullForNew   CP_CSW_CFG_BASE+47
#define CP_CMID_CfgGetSmsFullForNew  CP_CSW_CFG_BASE+48
#define CP_CMID_CfgSetSmsParam   CP_CSW_CFG_BASE+49
#define CP_CMID_CfgGetSmsParam   CP_CSW_CFG_BASE+50

#define CP_CMID_CfgGetDefaultSmsParam CP_CSW_CFG_BASE+51
#define CP_CMID_CfgSetDefaultSmsParam CP_CSW_CFG_BASE+52
#define CP_CMID_CfgSetSmsStorageInfo  CP_CSW_CFG_BASE+53
#define CP_CMID_CfgGetSmsStorageInfo  CP_CSW_CFG_BASE+54
#define CP_CMID_CfgSetNewSmsOption    CP_CSW_CFG_BASE+55

#define CP_CMID_CfgGetNewSmsOption   CP_CSW_CFG_BASE+56
//pbk part
#define CP_CMID_CfgSetPbkStorage   CP_CSW_CFG_BASE+57
#define CP_CMID_CfgGetPbkStorage   CP_CSW_CFG_BASE+58
#define CP_CMID_CfgSetPbkStrorageInfo   CP_CSW_CFG_BASE+59
#define CP_CMID_CfgGetPbkStrorageInfo   CP_CSW_CFG_BASE+60

#define CP_CMID_CfgSetPbkCapacityInfo   CP_CSW_CFG_BASE+61
#define CP_CMID_CfgSetCalllogCapacityInfo CP_CSW_CFG_BASE+62
//nw part
#define CP_CMID_CfgSetNwOperDispFormat CP_CSW_CFG_BASE+63
#define CP_CMID_CfgGetNwOperDispFormat CP_CSW_CFG_BASE+64
#define CP_CMID_CfgNwGetOperatorId  CP_CSW_CFG_BASE+65

#define CP_CMID_CfgNwGetOperatorName    CP_CSW_CFG_BASE+66
#define CP_CMID_CfgNwGetOperatorInfo    CP_CSW_CFG_BASE+67
#define CP_CMID_CfgSetNwStatus   CP_CSW_CFG_BASE+68
#define CP_CMID_CfgGetNwStatus   CP_CSW_CFG_BASE+69
#define CP_CMID_CfgNwSetFrequencyBand    CP_CSW_CFG_BASE+70

#define CP_CMID_CfgNwGetFrequencyBand CP_CSW_CFG_BASE+71
#define CP_CMID_CfgNwSetNetWorkMode CP_CSW_CFG_BASE+72
#define CP_CMID_CfgNwGetNetWorkMode CP_CSW_CFG_BASE+73
//cm part
#define CP_CMID_CfgSetSSN  CP_CSW_CFG_BASE+74
#define CP_CMID_CfgGetSSN   CP_CSW_CFG_BASE+75

#define CP_CMID_CfgSetCallWaiting  CP_CSW_CFG_BASE+76
#define CP_CMID_CfgGetCallWaiting  CP_CSW_CFG_BASE+77
#define CP_CMID_CfgSetClir   CP_CSW_CFG_BASE+78
#define CP_CMID_CfgGetClir   CP_CSW_CFG_BASE+79
#define CP_CMID_CfgSetToneDuration CP_CSW_CFG_BASE+80

#define CP_CMID_CfgGetToneDuration CP_CSW_CFG_BASE+81
#define CP_CMID_CfgSetClip  CP_CSW_CFG_BASE+82
#define CP_CMID_CfgGetClip  CP_CSW_CFG_BASE+83
#define CP_CMID_CfgSetCallForwarding CP_CSW_CFG_BASE+84
#define CP_CMID_CfgGetCallForwarding CP_CSW_CFG_BASE+85

#define CP_CMID_CfgSetIncomingCallResultMode CP_CSW_CFG_BASE+86
#define CP_CMID_CfgGetIncomingCallResultMode CP_CSW_CFG_BASE+87
#define CP_CMID_CfgSetBearServType CP_CSW_CFG_BASE+88
#define CP_CMID_CfgGetBearServType CP_CSW_CFG_BASE+89
#define CP_CMID_CfgSetConnectResultFormatCode CP_CSW_CFG_BASE+90

#define CP_CMID_CfgGetConnectResultFormatCode CP_CSW_CFG_BASE+91
#define CP_CMID_CfgSetColp  CP_CSW_CFG_BASE+92
#define CP_CMID_CfgGetColp  CP_CSW_CFG_BASE+93
//device part
#define CP_CMID_CfgSetAudioAudioMode   CP_CSW_CFG_BASE+94
#define CP_CMID_CfgGetAudioAudioMode   CP_CSW_CFG_BASE+95

#define CP_CMID_CfgSetLoudspeakerVolumeLevel   CP_CSW_CFG_BASE+96
#define CP_CMID_CfgGetLoudspeakerVolumeLevel   CP_CSW_CFG_BASE+97
#define CP_CMID_CfgGetLoudspeakerVolumeLevelRange    CP_CSW_CFG_BASE+98
//tm part
#define CP_CMID_CfgSetTmParam    CP_CSW_CFG_BASE+99
#define CP_CMID_CfgGetTmParam    CP_CSW_CFG_BASE+100

//init part
#define CP_CMID_Cfg_SetInitValue    CP_CSW_CFG_BASE+101
#define CP_CMID_CfgInit    CP_CSW_CFG_BASE+102
//main part
#define CP_CMID_Cfg_atoi    CP_CSW_CFG_BASE+103
#define CP_GetNumber    CP_CSW_CFG_BASE+104
#define CP_CMID_CfgNumRangeCheck   CP_CSW_CFG_BASE+105

#define CP_GetString   CP_CSW_CFG_BASE+106
#define CP_CMID_Cfg_strcmp   CP_CSW_CFG_BASE+107
#define CP_CMID_CfgStrRangeCheck   CP_CSW_CFG_BASE+108
...
#define CP_CMID_CfgGprsSetPdpCxt        CP_CSW_CFG_BASE+128
#define CP_CMID_CfgGprsGetPdpCxt        CP_CSW_CFG_BASE+129 
#define CP_CMID_CfgGprsSetReqQos        CP_CSW_CFG_BASE+130
#define CP_CMID_CfgGprsGetReqQos        CP_CSW_CFG_BASE+131
#define CP_CMID_CfgGprsSetMinQos        CP_CSW_CFG_BASE+132
#define CP_CMID_CfgGprsGetMInQos        CP_CSW_CFG_BASE+133
#define CP_CMID_CfgGetEmodParam         CP_CSW_CFG_BASE+134
#define CP_CMID_CfgSetEmodParam         CP_CSW_CFG_BASE+135

#endif /* __CP_CMID_H__ */

#endif	//fixme-asr-remove
