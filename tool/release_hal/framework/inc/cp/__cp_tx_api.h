...
#define TX_BLOCK_POOL_ENABLE_PERFORMANCE_INFO //Pijing Liu
...
#define tx_queue_receive_ex                         _tx_queue_receive_ex
#define tx_queue_send                               _tx_queue_send
#define tx_queue_send_ex                            _tx_queue_send_ex
...
/* Re-map thread create/delete if running our stack scan code */
  ...
  #define tx_thread_create          _txs_thread_create
  #define tx_thread_delete          _txs_thread_delete
#else
...
#define tx_hisr_create 								_tx_hisr_create
#define tx_hisr_activate							_tx_hisr_activate
#define tx_hisr_delete								_tx_hisr_delete	
...
#define tx_queue_receive_ex                         _txe_queue_receive_ex
#define tx_queue_send                               _txe_queue_send
#define tx_queue_send_ex                            _txe_queue_send_ex
...
UINT        tx_queue_receive_ex(TX_QUEUE *queue_ptr, VOID *destination_ptr, ULONG size, ULONG wait_option);
UINT        tx_queue_send(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG wait_option);
UINT        tx_queue_send_ex(TX_QUEUE *queue_ptr, VOID *source_ptr, ULONG size, ULONG wait_option);
...
#ifdef HAVE_DEBUG_STACK_SCAN
UINT        _txs_thread_create(TX_THREAD *thread_ptr, CHAR *name_ptr, 
