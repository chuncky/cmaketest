#ifndef ___CP_PIMC_API_H_
#define ___CP_PIMC_API_H_
...
#define PMIC_813 0x3 /* PM813: 0x30(A0), 0x31(A1)... */
...
#define PM812_POWERDOWN_LOG_REG2 0xe6
...
#define PM812_MEAS_TO_ENABLE_REG(meas_en) ((meas_en > PM812_VBBAT_MEAS_EN) ? PM812_GPADC_MEAS_ENABLE_1_REG : PM812_GPADC_MEAS_ENABLE_2_REG)
#define PM812_MEAS_TO_ENABLE_BIT(meas_en) (0x01<<(meas_en%8))
...
void PMIC_WRITE_REG_TEST(UINT8 addr, UINT8 value);
UINT8 PMIC_READ_REG_TEST(UINT8 addr);
...
static void PM812_LDO_Enable(int ldo_num,BOOL OnOff);
static void PM812_LDO_VOUT_CFG(int addr,int act_vol,int slp_vol);
static void PM812_WRITE_REG_BASE(UINT8 addr, UINT8 value);
static UINT8 PM812_READ_REG_BASE(UINT8 addr);
static UINT32 PM812_GET_RTC_REG_32(UINT8 start);
static void PM812_SET_RTC_REG_32(UINT8 start,UINT32 data);
static UINT8 PM812_GET_POWER_UP_LOG(void);
static void PM812_CLR_POWER_UP_LOG(UINT8 tmp);
static UINT8 PM812_GET_POWER_DOWN_LOG(void);
static void PM812_CLR_POWER_DOWN_LOG(UINT8 tmp);
static UINT8 PM812_GET_POWER_DOWN_LOG2(void);
static void PM812_CLR_POWER_DOWN_LOG2(UINT8 tmp);
static UINT32 PM812_GET_INT_TO_HOST_ENABLE_REG(void);
static UINT32 PM812_GET_INT_TO_HOST_STATUS_REG(void);
static void PM812_CLEAR_INT_TO_HOST_STATUS_REG(void);
static void PM812_PRE_REG_SNAPSHOT(void);
static void PM812_INT_TO_HOST_ENABLE(PM812_INTC intc);
static void PM812_INT_TO_HOST_DISABLE(PM812_INTC intc);
static void PM812_POWER_UP_ACTIONS(void);

void PM812_SW_RESET();
void PM812_SW_PDOWN();
void PM812_DUMP_STATE();

void PM812_SET_WD_TIMEOUT_ACT(UINT8 timeout);
void PM812_WD_RESET(void);
void PM812_WD_ENABLE(BOOL enable);

UINT8 PM812_RTC_GET_CONTROL_REG();
void PM812_RTC_SET_CONTROL_REG(UINT8 ctl);
UINT32 PM812_RTC_GET_32B_COUNTER();
UINT32 PM812_RTC_GET_32B_OFFSET();
void PM812_RTC_SET_32B_OFFSET(UINT32 offset);
UINT32 PM812_RTC_GET_32B_EXPIR_1();
UINT32 PM812_RTC_GET_32B_EXPIR_2();
void PM812_RTC_SET_32B_EXPIR_1(UINT32 expir);
void PM812_RTC_SET_32B_EXPIR_2(UINT32 expir);
void PM812_RTC_ENABLE_EXPIR_1();
void PM812_RTC_ENABLE_EXPIR_2();
void PM812_RTC_DISABLE_EXPIR_1();
void PM812_RTC_DISABLE_EXPIR_2();
void PM812_RTC_USE_XO();
BOOL PM812_IS_ALARM_TRIGGERD_POWERUP(void);
...
void PMIC_Phase1Init();
void PMIC_Phase2Init();
void PM812_INT_DISABLE(PM812_INTC intc);
void PM812_INT_ENABLE(PM812_INTC intc);
void PM812_INT_CALLBACK_REGISTER(PM812_INTC intc,PmicCallback isr);
static void PMIC_HISR_FUNC(void);
static void PMIC_LISR_FUNC(UINT32 isr);

//BOOL PM812_CHARGER_IS_DETECTED(void);
//BOOL PM812_VBUS_IS_AVAILABLE(void);
UINT32 PM812_GET_VCHG_LOW_TH(void);
UINT32 PM812_GET_VCHG_UPP_TH(void);
void PM812_SET_VCHG_LOW_TH(UINT8 low);
void PM812_SET_VCHG_UPP_TH(UINT8 upp);
UINT16 PM812_GPADC_READ_VOL_MEAS(UINT8 meaReg);

void PM812_BIAS_ENABLE(PM812_BIAS_EN bias_en);
void PM812_BIAS_DISABLE(PM812_BIAS_EN bias_en);
void PM812_BIAS_OUT_ON(PM812_BIAS_OUT bias_out);
void PM812_BIAS_OUT_OFF(PM812_BIAS_OUT bias_out);

void PM812_MEAS_ENABLE(PM812_MEAS_EN meas_en);
void PM812_MEAS_DISABLE(PM812_MEAS_EN meas_en);
void PM812_GPADC_SW_TRIG(void);

BOOL PM812_EXTON_IS_DETECTED(void);
BOOL PM812_BATTERY_IS_DETECTED(void);
void PM812_BD_ENABLE(UINT8 bit);
void PM812_BD_DISABLE(UINT8 bit);

UINT8 PM812_GET_POWER_UP_REASON(void);
UINT8 PM812_GET_POWER_DOWN_REASON(void);
UINT8 PM812_GET_POWER_DOWN_REASON2(void);
BOOL PM812_ONKEY_IS_DETECTED(void);
void PM812_LONKEY_ENABLE_SET(UINT8 LONGKEY_NUM,BOOL enable);
void PM812_SET_LONKEY_PRESS_TIME(UINT8 sec);

void PM812_VBUCK1_CFG(UINT8 value); //Refer to PMIC_BUCK_T for "value"
void PM812_VBUCK2_CFG(UINT8 value); //Refer to PMIC_BUCK_T for "value"
void PM812_PwmSetLevel(UINT8 level); //0 for PMIC PWM off, 1 for on.
...
typedef enum {
    CAM_VDD_1V20 = 0x0,
    CAM_VDD_1V25, 
    CAM_VDD_1V70, /* PM813 IOVdd suported point */
    CAM_VDD_1V80, /* PM813 IOVdd suported point */
    CAM_VDD_1V85, 
    CAM_VDD_1V90, /* PM813 IOVdd suported point */ 
    CAM_VDD_2V50, /* PM813 IOVdd suported point */ 
    CAM_VDD_2V60, 
    CAM_VDD_2V70, 
    CAM_VDD_2V75, 
    CAM_VDD_2V80, /* PM813 IOVdd suported point */ 
    CAM_VDD_2V85, 
    CAM_VDD_2V90, /* PM813 IOVdd suported point */ 
    CAM_VDD_3V00, 
    CAM_VDD_3V10, /* PM813 IOVdd suported point */ 
    CAM_VDD_3V30, /* PM813 IOVdd suported point */
    CAM_VDD_MAX = CAM_VDD_3V30
}Camera_Pwr_Val ;

void Camera_Avdd_Power_set(Camera_Pwr_Val ldoVal);
void Camera_Dvdd_Power_set(Camera_Pwr_Val ldoVal);
void Camera_IOvdd_Power_set(Camera_Pwr_Val ldoVal);

#define PMIC_REG_FOR_USR_DEF_FLAGS_STR      0xE8
#define PMIC_REG_FOR_SW_RESTART_REASON_STR  0xE9
...
void SysRestartReasonSet(SW_RESTART_REASON reason);
UINT8 SysRestartReasonGet(void);
UINT8 isSysRestartByCharging(void);
//UINT8 isSysRestartByRdProduction(void);
UINT8 isSysRestartByAlarm(void);
UINT8 isSysRestartByNormal(void);
UINT8 isSysRestartByError(void);
