...
#define OTA_LOG_I(fmt, ...) uart_printf("[%s] [%s] [%d]: "fmt"\r\n",__FILE__,__func__, __LINE__, ##__VA_ARGS__)	//ALIOTA
...
#include <string.h>
#else
extern unsigned int Image$$ALIFOTA_HEAP_START$$Base;		//start address:0x7E800000
extern unsigned int Image$$ALIFOTA_HEAP_ENDMARK$$Base;		//size:8M



#define XZ_HEAP_BASE ((int)&Image$$ALIFOTA_HEAP_START$$Base)
#define XZ_HEAP_SIZE ((int)&Image$$ALIFOTA_HEAP_ENDMARK$$Base - (int)&Image$$ALIFOTA_HEAP_START$$Base)
