...
::**********************************3. ST7789VER1***************************************************
::START
::3.1 USE_FOTA: REDSTONE_AND_ALI
make clean
set LCD_TYPE=ST7789VER1
...
if not exist %DIR_RELEASE%\updater_st7789ver1_redstone_and_ali.bin goto ERROR
::goto SUCCESS
...
if not exist %DIR_RELEASE%\updater_st7789ver1_adups.bin goto ERROR
goto SUCCESS
