...
::**********************************5. GC9306VER2***************************************************
::START
::5.1 USE_FOTA: REDSTONE_AND_ALI
make clean
set LCD_TYPE=GC9306VER2
...
if not exist %DIR_RELEASE%\updater_gc9306ver2_redstone_and_ali.bin goto ERROR
::goto SUCCESS
...
if not exist %DIR_RELEASE%\updater_gc9306ver2_adups.bin goto ERROR
goto SUCCESS
