...
if not exist %DIR_RELEASE%\updater_lcd_adapt_adups.bin goto ERROR
::goto SUCCESS
...
if not exist %DIR_RELEASE%\updater_lcd_adapt_asrsd.bin goto ERROR
::goto SUCCESS

::START
::1.3 USE_FOTA:REDSTONE_AND_ALI
make clean
set LCD_TYPE=LCD_ADAPT
...
if not exist %DIR_RELEASE%\updater_lcd_adapt_redstone_and_ali.bin goto ERROR
::goto SUCCESS

::comment following type, debug lcd driver
goto comment_FOTA_NO_LCD_ASRSPI
::START
::1.4 USE_FOTA: ASRSPI
make clean
set LCD_TYPE=NO_LCD
...
if not exist %DIR_RELEASE%\updater_lcd_adapt_asrdm.bin goto ERROR
::goto SUCCESS
...
::**********************************1.2 ST7789VER2***************************************************
::START
::1.2.1 USE_FOTA:ADUPS
make clean
set LCD_TYPE=ST7789VER2
set FOTA_TYPE=ADUPS
make 
copy /Y updater*.bin %DIR_RELEASE%\
copy /Y updater*.axf %DIR_RELEASE%\updater_axf_map\
...
if not exist %DIR_RELEASE%\updater_st7789ver2_adups.bin goto ERROR
goto SUCCESS
