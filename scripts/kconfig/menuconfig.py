...
#
# Note: 
#  This py runs at WORKING_DIRECTORY of ${PROJECT_BINARY_DIR}/kconfig
#  which is called by Kconfig.cmake.
#
sys.path.append('..\\..\\..\\scripts\\kconfig')
#sys.path.append('E:\\yikeqi\\feature_phone\\svn\\scripts\\kconfig')
